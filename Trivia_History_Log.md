## 2026-08-12 — Topic: Can You Beat a 5th Grader?
Angle taken: Mixed-subject elementary-curriculum trivia (math, science, grammar, geography, history) framed as "adults vs. 5th grade knowledge."
Facts tested:
- Equivalent fractions (3/6 = 1/2)
- Rhode Island is the smallest U.S. state by area
- Most plant biomass comes from air (CO2), not soil
- "Beautifully" is an adverb (part of speech)
- Order of operations: 8 − 2 × 3 = 2
- Thomas Jefferson is on the $2 bill
- Mars is the 4th planet from the Sun
- Lake Champlain is not one of the five Great Lakes
